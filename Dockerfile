...
RUN  apt-get update -y && apt-get install software-properties-common -y &&  add-apt-repository ppa:webupd8team/java && apt-get install oracle-java11-installer maven -y
